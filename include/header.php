                ...
                <div class="collapse navbar-collapse yamm" id="navigation">
                    ...
                    <ul class="main-nav nav navbar-nav navbar-right">
                       ...
                       <li class="dropdown ymm-sw " data-wow-delay="0.1s">
                            <a href="property.html" class="dropdown-toggle active" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Property <b class="caret"></b></a>
                            <ul class="dropdown-menu navbar-nav">
                                <li>
                                    <a href="#">RESIDENCES</a>
                                </li>
                                <li>
                                    <a href="#"> COMMERCIAL - OFFICES </a>
                                </li>
                                <li>
                                    <a href="#">SCHOOL</a>
                                </li>
                        ...
                        <li class="wow fadeInDown" data-wow-delay="0.4s"><a href="contact.php">Contact Us</a></li>
                    </ul>
                </div><!-- /.navbar-collapse -->
            </div><!-- /.container-fluid -->
        </nav>
